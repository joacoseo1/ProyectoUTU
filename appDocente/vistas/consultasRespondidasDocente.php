...
<!--===============================================================================================-->
    ...
    <title>Consultas Respondidas</title>
</head>
<body>
<div class="contact1">
...
<form>
            ...
            foreach($parametros['consultasRespondidas'] as $filas){
				...
				<div class="wrap-input1 validate-input">
                    <label id="txtFecha">Fecha Enviado</label>
				...
				<div class="wrap-input1 validate-input">
					...
					<textarea style="resize:none;" disabled="disabled" class="input1" name="respuesta" placeholder="<?php echo $filas['respuesta']?>"></textarea>
					<span class="shadow-input1"></span>
				</div>
	...
	<script src="/static/js/languages/consultasRespondidasDocente.js"></script>
<!--===============================================================================================-->
