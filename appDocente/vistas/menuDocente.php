...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 id="txtMenu" class="mb-4">Menu Docente</h2>
        <a href="ingresarGrupoDocente" ><img id="txtImg" src="/static/img/grupo.png" style="margin-top:17.4%;
      ...
      <h2 class="mb-4" style="color:#fff; visibility:hidden;">Menu</h2>
        <a href="gruposDocente"><img  id="txtImg2" src="/static/img/chats.png" style="margin-top:17.4%;
        margin-left:10%; border: 4px solid black; padding:2%; box-shadow: 0px 5px 25px rgba(0,0,0,1);" alt=""></a>
      </div>
		</div>
    
    <script src="/static/js/languages/menuDocente.js"></script>
