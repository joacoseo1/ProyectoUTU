...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 id="txtTitulo" class="mb-4" style="color:black;">Chats y Consultas</h2>
        <a  href="GrupoSeleccionadoDocente"><img id="srcConsultas" src="/static/img/group.png" style="margin-top:17.4%;
      ...
      <h2 class="mb-4" style="color:#fff; visibility:hidden;">Menu</h2>
        <a href="chatMenuDocente"><img src="/static/img/chatImg.png" style="margin-top:17.4%;
        margin-left:10%; border: 4px solid black; padding:2%; box-shadow: 0px 5px 25px rgba(0,0,0,1);" alt=""></a>
      </div>
		</div>
    <script src="/static/js/languages/ChatConsultas.js"></script>
