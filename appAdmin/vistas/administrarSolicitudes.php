...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4">Menu Solicitudes</h2>
        <div style="margin-left:480px; margin-top:220px;">
        <a style="margin-right:62px;font-size: 20px;" class="btn-solid-lg page-scroll" href="listarDeSolicitudes">Listar Todas las Solicitudes</a>
</div>
    <div style="margin-top:130px;margin-left:502px;">
        <a style="padding-right:50px;font-size: 20px;" class="btn-solid-lg page-scroll" href="busquedaFocalizada">Busqueda Focalizada</a>
      </div>
      </div>
		</div>
