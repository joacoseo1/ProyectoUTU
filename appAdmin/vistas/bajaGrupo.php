...
<table style="width:100px; border: 1px solid black" class="table table-bordered">
    <thead>
      <tr>
        <th style="font-size: 20px; text-align:center;">Grupo</th>
    ...
    <?php
           foreach ($parametros['grupos'] as $filas) {
            $id = $filas['id'];
            $nombreGrupo= $filas['nombre'];
            
               ?>
      <form action="/bajaGrupo" method='post'>
      <tr>
        <td class="nombreGrupo" ><?php echo $nombreGrupo;?></td>
