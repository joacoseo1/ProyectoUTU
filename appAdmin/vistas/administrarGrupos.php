...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4">Menu Grupos</h2>
        <a href="altaGrupo"><img src="/static/img/add-group.png" style="margin-top:17.4%;
      ...
      <h2 class="mb-4" style="color:#fff; visibility:hidden;">Menu</h2>
        <a href="bajaGrupo"><img src="/static/img/groupDelete.png" style="margin-top:17.4%;
