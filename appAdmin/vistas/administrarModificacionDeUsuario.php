...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4">Menu Modificar Usuarios</h2>
        <div style="margin-left:480px; margin-top:220px;">
        <a style="margin-right:62px;font-size: 20px;" class="btn-solid-lg page-scroll" href="listarParaModificar">Listar Todas los Usuarios</a>
</div>
    <div style="margin-top:130px;margin-left:496px;">
        <a style="padding-right:50px;font-size: 20px;" class="btn-solid-lg page-scroll" href="busquedaFocalizadaModificar">Busqueda Focalizada</a>
      </div>
      </div>
		</div>
