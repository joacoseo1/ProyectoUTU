...
<table style="margin-left:0;margin-top:50px;border: 1px solid black" class="table table-bordered">
    <thead>
      <tr>
        ...
        <th style="font-size: 18px; text-align:center;">Tipo</th>
        <th style="font-size: 18px; text-align:center;">CI</th>
        <th style="font-size: 18px; text-align:center;">Nombre</th>
        <th style="font-size: 18px; text-align:center;">Apellido</th>
        <th style="font-size: 18px; text-align:center;">Modificar</th>
      </tr>
    </thead>
    <tbody>
    <?php
           foreach ($parametros['usuarios'] as $filas) {
            ...
            $tipo = $filas['tipo'];
               ...
               ?>
      <form action="/listarParaModificar" method='post'>
      <tr>
        <td style="text-align:center;" class="solicitudes" ><?php echo $id;?></td>
        <td style="text-align:center;"  class="solicitudes" ><?php echo $tipo;?></td>
        ...
        <td><input style="margin:auto;" name="boton" class='botonAceptar' type='submit' value='Modificar'></td>
