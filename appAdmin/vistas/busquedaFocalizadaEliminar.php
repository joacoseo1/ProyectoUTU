...
<div class="wrapper d-flex align-items-stretch">
    ...
    <?php endif; ?>
        ...
        <section>
        <h1>Eliminacion Focalizada</h1>
            <form class="formulario" method="post" action="busquedaFocalizadaEliminar">
            <div class="datos">
                <legend>Ingrese Cedula a Eliminar</legend>
                <p>Cedula</p>
                <input class="datosInput" type="text" name="cedula" placeholder="Cedula">
                <input class="botonAceptar" type="submit" value="Eliminar">
</div>
            </form>
        </section>
</div>
