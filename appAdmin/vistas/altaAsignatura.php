...
<html lang="en">
  ...
  <body>
        ...
        <h2 class="mb-4">Añadir Asignatura</h2>
        <section>
            <form class="formulario" method="post" action="altaAsignatura">
            <div class="datos">
                <legend>Ingrese nombre de la Asignatura</legend>
                <p>Asignatura</p>
                <input class="datosInput" type="text" name="asignaturaNombre" placeholder="Nombre de la Asignatura">
