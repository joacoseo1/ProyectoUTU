...
<div class="wrapper d-flex align-items-stretch">
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="menuDocente"><span class="fa fa-home mr-3"></span> Menu</a>
          </li>
          <li>
              <a href="modificarDocente"><span class="fa fa-pencil mr-3"></span> Modificar Perfil</a>
          </li>
          <li>
            <a href="eliminarDocente"><span class="fa fa-ban mr-3""></span> Eliminar Perfil</a>
          </li>
          <li>
    ...
    <form class="formulario" method="post" action="ingresarGrupoAlumno">
        <div class="container">
            ...
            <h2 class="titulo2">Grupos Disponibles</h2>
          ...
          <input class="botonAceptar" type="submit" value="Solicitar Ingreso">
    </form>
