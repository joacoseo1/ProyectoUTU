...
<div class="container-contact1">
			...
			<form class="contact1-form validate-form" method="post" action="enviarConsulta">
				...
				<div class="wrap-input1 validate-input">
					<label>Titulo</label>
					<input class="input1" type="text" name="titulo" placeholder="Titulo">
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" data-validate = "Message is required" >
					<label>Respuesta</label>
					<textarea style="resize:none;" class="input1" name="consulta" placeholder="Respuesta"></textarea>
					<span class="shadow-input1"></span>
				</div>
