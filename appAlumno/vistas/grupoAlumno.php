...
<div class="wrapper d-flex align-items-stretch">
  ...
  <h2 class="titulo2">Seleccione un grupo</h2>
  <div style="width:330px; margin-left:-3%; margin-top:5%">
    <select class="custom-select md-form" id='grupos' name='grupos[]'>
            ...
            foreach($parametros['grupos'] as $filas){ 
              ...
              $nombre=$filas['nombre'];
              echo "<option value='$idGrupo'>$nombre </option>";}
            
            ?>
        </select>
  </div>
        <input class='botonAceptar' style="margin-left:37%; margin-top:20%" type='submit' value='Aceptar'>
    </form>
