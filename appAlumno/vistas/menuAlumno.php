...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4">Menu Alumno</h2>
        <a href="ingresarGrupoAlumno"><img src="/static/img/grupo.png" style="margin-top:17.4%;
      ...
      <h2 class="mb-4" style="color:#fff; visibility:hidden;">Menu</h2>
        <a href="gruposAlumno"><img src="/static/img/chats.png" style="margin-top:17.4%;
